...
set output 'tscores.png'

set key outside below

set ylabel 'load value'
...
#set xrange [0:2362.146]
#set yrange [0:173]

set border 0

plot  'tscores.data' using 1:2 with dots title "Actual load", 'tscores.data' using 1:3 with dots title "Permitted maximum load";
