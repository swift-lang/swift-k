...
import org.globus.cog.gridshell.tasks.GetfileTask;
import org.globus.cog.gridshell.tasks.StartTask;
/**
 * 
 */
public class Getfile extends AbstractSrcDestinationCommand {
	/* (non-Javadoc)
	...
	public AbstractFileOperationTask createSrcDestinationTask(StartTask connection, String source, String destination) 
		...
		return new GetfileTask(connection,source,destination);
	}
}
