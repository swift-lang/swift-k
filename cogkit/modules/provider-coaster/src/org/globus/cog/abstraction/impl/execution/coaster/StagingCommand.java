...
public abstract class StagingCommand extends Command {
    public static final Logger logger = Logger.getLogger(StagingCommand.class);
    
    private StagingSet stagingSet;
    
    protected StagingCommand(String name, StagingSet stagingSet) {
        super(name);
        this.stagingSet = stagingSet;
    }
    ...
    protected void serialize() throws IOException {
        ...
        for (StagingSetEntry e : stagingSet) {
            add(sb, e.getSource() + '\n' + 
        ...
        if (logger.isDebugEnabled()) {
            logger.debug(this.getOutCmd() + " data: " + out);
        }
