...
public class IMappingParameter extends AbstractINode {
    private String name;
    private IExpression value;
    
    public IMappingParameter() {
        super();
    }
    
    public IMappingParameter(String name, IExpression value) {
        super();
        this.name = name;
        this.value = value;
    }
