...
public class ITypeDefinition extends AbstractINode {
    private String name;
    private String typeAlias;
    private List<IStructMember> structMembers;
    ...
    public void addStructMember(IStructMember iStructMember) {
        structMembers = lazyAdd(structMembers, iStructMember);
    }
    ...
    protected void setTemplateAttributes(OutputContext oc, StringTemplate st) {
        ...
        if (structMembers != null) {
            setAll(oc, st, structMembers, "members");
        }
    }
