 ...
 */
public class WhileImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.griphyn.vdl.model.While
{
    ...
    private static final javax.xml.namespace.QName TEST$22 = 
    ...
    public java.lang.String getTest()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(TEST$22);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetTest()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(TEST$22);
            return target;
        }
    }
    ...
    public boolean isSetTest()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(TEST$22) != null;
        }
    }
    ...
    public void setTest(java.lang.String test)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(TEST$22);
            }
    ...
    public void xsetTest(org.apache.xmlbeans.XmlString test)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(TEST$22);
            }
            target.set(test);
        }
    }
    ...
    public void unsetTest()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(TEST$22);
        }
    }
}
