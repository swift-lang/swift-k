...
public class SimpleHTTPServer implements Runnable {
    ...
    public void start() throws IOException {
        ...
        t.setDaemon(true);
        t.setName("HTTP Server Connection Processor");
        t.start();
        synchronized(this) {
            try {
                while (!started) {
    ...
    public void run() {
        while (true) {
            try {
                ...
                logger.info("Caught exception in HTTP service", e);
            }
        }
    }
    ...
    protected class ConnectionProcessor implements Runnable {
        ...
        public ConnectionProcessor(SimpleHTTPServer server) throws IOException {
            this.server = server;
    ...
    protected class ConnectionState {
        ...
        public ConnectionState(ConnectionProcessor processor, Socket socket, SimpleHTTPServer server) {
