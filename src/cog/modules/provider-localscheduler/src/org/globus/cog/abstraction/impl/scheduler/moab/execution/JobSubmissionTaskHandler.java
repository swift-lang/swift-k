...
package org.globus.cog.abstraction.impl.scheduler.moab.execution;
...
import org.globus.cog.abstraction.impl.scheduler.moab.MoabExecutor;
...
public class JobSubmissionTaskHandler extends AbstractJobSubmissionTaskHandler {
	protected AbstractExecutor newExecutor(Task task,
		...
		return new MoabExecutor(task, th);
	}
}
