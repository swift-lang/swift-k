...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>Historical: Virtual Data Language Reference Manual</title><meta name="generator" content="DocBook XSL Stylesheets V1.75.2"><link rel="home" href="index.html" title="Historical: Virtual Data Language Reference Manual"><link href="http://www.ci.uchicago.edu/swift/css/style1col.css" rel="stylesheet" type="text/css"><script type="text/javascript" src="http://www.ci.uchicago.edu/swift/dhtml.js"></script><script type="text/javascript" src="http://www.ci.uchicago.edu/swift/shCoreu.js"></script><script type="text/javascript" src="http://www.ci.uchicago.edu/swift/shBrushVDL2.js"></script></head><body onLoad="initjs();sh();" class="section-3">
		...
		<div class="article" title="Historical: Virtual Data Language Reference Manual"><div class="titlepage"><div><div><h2 class="title"><a name="id2439501"></a>Historical: Virtual Data Language Reference Manual</h2></div><div><h3 class="subtitle"><i>Document Version: 0.6</i></h3></div><div><div class="author"><h3 class="author"><span class="firstname">Yong</span> <span class="surname">Zhao</span></h3></div></div></div><hr></div><div class="toc"><p><b>Table of Contents</b></p><dl><dt><span class="sect1"><a href="#id2506715">1. Introduction</a></span></dt><dt><span class="sect1"><a href="#id2506801">2. Namespaces</a></span></dt><dt><span class="sect1"><a href="#id2506854">3. Lexical structure</a></span></dt><dd><dl><dt><span class="sect2"><a href="#id2507541">3.1. Comments</a></span></dt><dt><span class="sect2"><a href="#id2507572">3.2. Identifiers</a></span></dt><dt><span class="sect2"><a href="#id2507836">3.3. Keywords</a></span></dt><dt><span class="sect2"><a href="#id2568133">3.4. Literals</a></span></dt><dt><span class="sect2"><a href="#id2568719">3.5. Operators and Separators</a></span></dt></dl></dd><dt><span class="sect1"><a href="#id2568875">4. Type Definitions</a></span></dt><dd><dl><dt><span class="sect2"><a href="#id2568892">4.1. Primitive types</a></span></dt><dt><span class="sect2"><a href="#id2568914">4.2. Composite types</a></span></dt><dt><span class="sect2"><a href="#id2568927">4.3. Arrays</a></span></dt><dt><span class="sect2"><a href="#id2568951">4.4. Structs</a></span></dt></dl></dd><dt><span class="sect1"><a href="#id2568963">5. Datasets</a></span></dt><dt><span class="sect1"><a href="#id2569050">6. Mapping</a></span></dt><dt><span class="sect1"><a href="#id2569112">7. Variables</a></span></dt><dd><dl><dt><span class="sect2"><a href="#id2569131">7.1. Global variables</a></span></dt><dt><span class="sect2"><a href="#id2569147">7.2. Local variables</a></span></dt><dt><span class="sect2"><a href="#id2569192">7.3. Dataset-bound variable</a></span></dt><dt><span class="sect2"><a href="#id2569214">7.4. Scopes</a></span></dt><dt><span class="sect2"><a href="#id2569231">7.5. Variable references</a></span></dt></dl></dd><dt><span class="sect1"><a href="#id2569286">8. Procedure Definitions</a></span></dt><dd><dl><dt><span class="sect2"><a href="#id2569637">8.1. Atomic procedure body</a></span></dt><dt><span class="sect2"><a href="#id2570353">8.2. Compound procedure body</a></span></dt></dl></dd><dt><span class="sect1"><a href="#id2570474">9. Expressions</a></span></dt><dd><dl><dt><span class="sect2"><a href="#id2570484">9.1. Primary Expressions</a></span></dt><dt><span class="sect2"><a href="#id2571267">9.2. Operators</a></span></dt></dl></dd><dt><span class="sect1"><a href="#id2571356">10. Statements</a></span></dt><dd><dl><dt><span class="sect2"><a href="#sect10_1">10.1. Namespace Statement</a></span></dt><dt><span class="sect2"><a href="#id2571554">10.2. Include Statements</a></span></dt><dt><span class="sect2"><a href="#id2571618">10.3. Type Definitions</a></span></dt><dt><span class="sect2"><a href="#id2572145">10.4. Declaration Statements</a></span></dt><dt><span class="sect2"><a href="#id2572766">10.5. Expression Statements</a></span></dt><dt><span class="sect2"><a href="#id2572788">10.6. Selection Statements</a></span></dt><dt><span class="sect2"><a href="#id2573199">10.7. Loop statements</a></span></dt><dt><span class="sect2"><a href="#id2573734">10.8. The break statement</a></span></dt><dt><span class="sect2"><a href="#id2573759">10.9. The continue statement</a></span></dt></dl></dd><dt><span class="sect1"><a href="#id2573784">11. Examples</a></span></dt><dt><span class="sect1"><a href="#id2573796">12. Extensions to consider</a></span></dt></dl></div><div class="sect1" title="1. Introduction"><div class="titlepage"><div><div><h2 class="title"><a name="id2506715"></a>1. Introduction</h2></div></div></div><p>VDL is a language for workflow specification in Data Grid environments, in which:</p><div class="itemizedlist"><ul class="itemizedlist" type="disc"><li class="listitem"><p>Data lives in files, in a variety of different file system organizations and file formats;</p></li><li class="listitem"><p>We want to be able to define and compose typed procedures that operate on such data; and</p></li><li class="listitem"><p>We want to be able to execute these procedures on distributed resources. </p></li></ul></div><p>VDL addresses the challenges associated with such environments by defining:</p><div class="itemizedlist"><ul class="itemizedlist" type="disc"><li class="listitem">a language for describing operations on typed <span class="emphasis"><em>data items</em></span>; and </li><li class="listitem">mechanisms for binding data items defined in this language to <span class="emphasis"><em>datasets</em></span> stored on persistent storage.</li></ul></div><p>The binding between data item and dataset is based on the XDTM (XML dataset typing and mapping) model [ref], which separates the declaration of the logical structure of datasets from their physical representation. The logical structure is specified via a subset of XML Schema, where a physical representation is defined by a mapping descriptor<span class="emphasis"><em>,</em></span> which describes how each element in the dataset’s VDL representation can be mapped to a corresponding physical structure such as a directory, file, or database table.</p><p>This manual documents the XDTM-based VDL, which uses a C-like syntax to represent XML Schema types and procedures. This C-like syntax is easier to read and write than XML, but can easily be mapped to XML. </p></div><div class="sect1" title="2. Namespaces"><div class="titlepage"><div><div><h2 class="title"><a name="id2506801"></a>2. Namespaces</h2></div></div></div><p>Since VDL is to be used in Grid environments, the type definitions and procedure definitions can be shared across multiple virtual organizations, groups, and project development stages. Thus namespaces issue is important to address.</p><p>In general, every type definition and procedure definition has an associated namespace. When they are referenced from within another namespace, they must be referenced with their namespace specified explicitly, so as to avoid any confliction with types and procedures defined in the origin namespace.</p><p>If the namespace for a definition is not specified, it uses </p><p>‘http://www.griphyn.org/vds/2006/08/nonamespace’ </p><p>as the default namespace. </p><p>A namespace prefix can be defined to represent an XML-style namespace (in the form of a URI or URN), We follow the XML <span class="emphasis"><em>prefix:localname</em></span> convention and use ‘:’ as the separator between the namespace and the local name of a definition. Examples of namespace declaration can be found in Section 
<a class="link" href="#sect10_1" title="10.1. Namespace Statement">???</a>.</p></div><div class="sect1" title="3. Lexical structure"><div class="titlepage"><div><div><h2 class="title"><a name="id2506854"></a>3. Lexical structure</h2></div></div></div><p>Lexical tokens follow the conventions of the C programming language. Specifically, there are five different tokens: identifiers, keywords, literals, operators, and other separators. White space (spaces, tabs, newlines) and comments are used to separate tokens and are ignored.</p><div class="sect2" title="3.1. Comments"><div class="titlepage"><div><div><h3 class="title"><a name="id2507541"></a>3.1. Comments</h3></div></div></div><p>The characters # or // starts a comment, which terminates when a newline is encountered. The C style /* and */ pair are used for multi-line comments.  For example:</p><pre class="programlisting">// this is a single-line comment</pre><pre class="programlisting"># this is another single-line comment </pre><pre class="programlisting">
/* multi-line comment line 1
   multi-line comment line 2 */
       </pre></div><div class="sect2" title="3.2. Identifiers"><div class="titlepage"><div><div><h3 class="title"><a name="id2507572"></a>3.2. Identifiers</h3></div></div></div><p>An identifier starts with an alphabetic character (‘a’-‘z’, ‘A’-‘Z’, ‘_’), after which there can be arbitrary number of letters or digits. Identifiers are case sensitive, meaning upper case letters are different from lower case ones. An identifier is used to represent the name of a variable, a procedure, a procedure argument, etc, which we’ll talk in detail in later sections.</p><div class="informaltable"><table border="1"><colgroup><col width="48.15pt"><col width="17.4pt"><col width="139.35pt"></colgroup><tbody><tr><td>
              ...
              <span class="emphasis"><em>’</em></span>
            </td></tr></tbody></table></div></div><div class="sect2" title="3.3. Keywords"><div class="titlepage"><div><div><h3 class="title"><a name="id2507836"></a>3.3. Keywords</h3></div></div></div><p>Keywords are identifiers that are reserved for system use, and may not be used otherwise. We have reserved the following identifiers for type declarations and control statements:</p><p>
      ...
      <span class="bold"><strong>until</strong></span>
    </p></div><div class="sect2" title="3.4. Literals"><div class="titlepage"><div><div><h3 class="title"><a name="id2568133"></a>3.4. Literals</h3></div></div></div><p>VDL <span class="emphasis"><em>literals</em></span> are constant values that are represented as strings in the program. The types and formats of literals are drawn from the set of atomic values defined by XML Schema. The type of a literal value is implicit from its context – from the type of the variable that its being assigned to or the type of the procedure parameter that it is being passed to, or the type of value that is expected in a specific position of a statement such as an <span class="emphasis"><em>if</em></span>, <span class="emphasis"><em>while</em></span>, or <span class="emphasis"><em>switch</em></span>.</p><p>Some literal types can be identified without being enclosed in quotes; string literals and similar types based on strings must be enclosed in quotes.</p><div class="sect3" title="3.4.1. Integer literals"><div class="titlepage"><div><div><h4 class="title"><a name="id2568168"></a>3.4.1. Integer literals</h4></div></div></div><p>An integer literal is a sequence of digits. (We may need to support octal and hexal integer literals too.)</p><div class="informaltable"><table border="1"><colgroup><col width="64.95pt"><col width="17.4pt"><col width="113.55pt"></colgroup><tbody><tr><td>
              <span class="emphasis"><em>
              ...
              <span class="emphasis"><em>digit</em></span>
              <span class="emphasis"><em>+</em></span>
            </td></tr></tbody></table></div><p>Examples of float literals are:</p><pre class="programlisting">3.  .14  3.14  3.14e-6  2e100</pre></div><div class="sect3" title="3.4.3. Boolean literals"><div class="titlepage"><div><div><h4 class="title"><a name="id2568599"></a>3.4.3. Boolean literals</h4></div></div></div><p>There are two boolean literals:<span class="bold"><strong> </strong></span><span class="bold"><strong>true</strong></span> and <span class="bold"><strong>false</strong></span>.</p></div><div class="sect3" title="3.4.4. Date literals"><div class="titlepage"><div><div><h4 class="title"><a name="id2568626"></a>3.4.4. Date literals</h4></div></div></div><p>A date literal is represented in quoted string conforming to ISO-8601 standard, for example:</p><pre class="programlisting">"2005-09-25T11:30:00Z"</pre></div><div class="sect3" title="3.4.5. String literals"><div class="titlepage"><div><div><h4 class="title"><a name="id2568644"></a>3.4.5. String literals</h4></div></div></div><p>A string literal is a sequence of characters surrounded by two double quotes. The special string literal <span class="bold"><strong>null</strong></span> is used to represent an uninitialized string. </p></div><div class="sect3" title="3.4.6. XML literals"><div class="titlepage"><div><div><h4 class="title"><a name="id2568663"></a>3.4.6. XML literals</h4></div></div></div><p>XML literals refers to verbatim XML documents. We use @ followed by a string representation of the XML document to denote such literals. For instance:</p><pre class="programlisting">@“<span style="color: red">&lt;volume&gt;<span style="color: red">&lt;image&gt;b1.img&lt;/image&gt;</span><span style="color: red">&lt;header&gt;b1.hdr&lt;/header&gt;</span>&lt;/volume&gt;</span>”</pre></div><div class="sect3" title="3.4.7. URI literals"><div class="titlepage"><div><div><h4 class="title"><a name="id2568689"></a>3.4.7. URI literals</h4></div></div></div><p>An URI literal is a string that conforms to the URI specification – IETF RFC 2396. (<a class="ulink" href="http://www.ietf.org/rfc/rfc2396.txt" target="_top">http://www.ietf.org/rfc/rfc2396.txt</a>).</p><p>Example: </p><pre class="programlisting">"http://www.griphyn.org/"</pre></div></div><div class="sect2" title="3.5. Operators and Separators"><div class="titlepage"><div><div><h3 class="title"><a name="id2568719"></a>3.5. Operators and Separators</h3></div></div></div><p>Operators are used in expressions for operations that involve one or more operands. Separators are for grouping and separation. The operators and separators are as follows:</p><p></p><div class="informaltable"><table border="1"><colgroup><col width="106.2pt"><col width="109.8pt"><col width="171pt"></colgroup><tbody><tr><td>Operators</td><td>() [ ] .</td><td>Procedure call, member reference</td></tr><tr><td> </td><td>=</td><td>Assignment operator</td></tr><tr><td> </td><td>+ - * / %</td><td>Arithmetic operators</td></tr><tr><td> </td><td>&gt; &lt; ==  !=  &gt;=  &lt;=</td><td>Relational operators</td></tr><tr><td> </td><td>&amp;&amp;  ||  !</td><td>Boolean operators</td></tr><tr><td>Separators</td><td>{ }  </td><td>Block separator</td></tr><tr><td> </td><td>&lt; &gt;</td><td>Mapper declaration</td></tr><tr><td> </td><td>,  :  ;</td><td>Others</td></tr></tbody></table></div></div></div><div class="sect1" title="4. Type Definitions"><div class="titlepage"><div><div><h2 class="title"><a name="id2568875"></a>4. Type Definitions</h2></div></div></div><p>All data objects processed by VDL are typed. We distinguish between <span class="emphasis"><em>primitive types</em></span> and <span class="emphasis"><em>composite types.</em></span></p><div class="sect2" title="4.1. Primitive types"><div class="titlepage"><div><div><h3 class="title"><a name="id2568892"></a>4.1. Primitive types</h3></div></div></div><p>A primitive type is one of <span class="bold"><strong>int, float,</strong></span><span class="bold"><strong> boolean, date, string, uri</strong></span>.</p></div><div class="sect2" title="4.2. Composite types"><div class="titlepage"><div><div><h3 class="title"><a name="id2568914"></a>4.2. Composite types</h3></div></div></div><p>A composite type is a type composed of primitive types. We support two kinds of type constructions: Arrays and Structs. We will talk more about these in the declaration section.</p></div><div class="sect2" title="4.3. Arrays"><div class="titlepage"><div><div><h3 class="title"><a name="id2568927"></a>4.3. Arrays</h3></div></div></div><p>An array is a data structure that contains zero or more elements that are all of the same type; this type is called the <span class="emphasis"><em>element type</em></span> of the array.</p><p>Arrays are indexed by integer values, and they are 0-indexed following the C convention.</p><p>Currently only one-dimensional arrays are supported.</p></div><div class="sect2" title="4.4. Structs"><div class="titlepage"><div><div><h3 class="title"><a name="id2568951"></a>4.4. Structs</h3></div></div></div><p>A struct is a data structure that can contain members of different types, where those types can be either primitive or composite types.</p></div></div><div class="sect1" title="5. Datasets"><div class="titlepage"><div><div><h2 class="title"><a name="id2568963"></a>5. Datasets</h2></div></div></div><p>VDL provides a logical programming model for data Grids. A VDL program consists of procedure calls that operate on data items. VDL provides the level of abstraction such that operations can be specified on a data item without regard to its physical location or representation. Within the VDL logical space, a data item is called a <span class="emphasis"><em>data object</em></span>, and its physical counterpart is called a <span class="emphasis"><em>dataset</em></span>.</p><p>A <span class="emphasis"><em>d</em></span><span class="emphasis"><em>ataset</em></span> is a data item that has persistent physical storage. Datasets have both logical representations and physical representations. A dataset’s logical structure is declared using VDL type definition, where its physical representation describes how the dataset is physically stored and cataloged on persistent storage.</p><p>A VDL program specifies the operations on a dataset’s logical structure. The physical dataset is accessed via a mapper, which translates between the physical, persistent structure of the dataset and its logical representation.</p><p>A physical dataset is referenced via a <span class="emphasis"><em>dataset handle</em></span>, which contains name, type, and mapping information. The name of the dataset handle uniquely identifies the dataset; the type information specifies the logical type the dataset conforms to; and the mapping information comprises the name of a <span class="emphasis"><em>mapping descriptor</em></span> and the necessary parameters to the mapper.  A dataset handle builds the connection between a data object and its corresponding physical dataset.</p><p>The declaration of a dataset handle is defined in Section <a class="link" href="#sect10_4_2" title="10.4.2. Dataset Declaration">???</a></p></div><div class="sect1" title="6. Mapping"><div class="titlepage"><div><div><h2 class="title"><a name="id2569050"></a>6. Mapping</h2></div></div></div><p>The process of mapping, as defined by XDTM, converts between a dataset’s physical representation (typically in persistent storage) and a logical XML view of that data. VDL programs operate on this logical view, and mapping functions implement the actions used to convert back and forth between the logical view and the physical representation.</p><p>Associated with each logical type is a mapping descriptor, which describes the implementation of the mapping functions and necessary mapping parameters to the implementation. </p><p>A mapping descriptor contains the following fields:</p><div class="itemizedlist"><ul class="itemizedlist" type="disc"><li class="listitem">name - name of the descriptor</li><li class="listitem">description- a brief description of the mapper</li><li class="listitem">type- name of the abstract type of the dataset to map</li><li class="listitem">implementation_class- java class that implements the mapping API</li><li class="listitem">parameters- parameters for the implementation class</li></ul></div><p>The implementation of the mapper must conform to the mapper API, which is a standard interface defined between mappers and data sources.  </p></div><div class="sect1" title="7. Variables"><div class="titlepage"><div><div><h2 class="title"><a name="id2569112"></a>7. Variables</h2></div></div></div><p>A variable represents a storage location. Each variable has a name and an associated type that determines what values can be stored in the variable. The value of a variable is the value currently stored in the storage location allocated to the variable. The value of a variable can be initialized or changed through assignment.</p><p>A variable consists of a name and a value. A value is either a literal, or a reference to a data item. </p><div class="sect2" title="7.1. Global variables"><div class="titlepage"><div><div><h3 class="title"><a name="id2569131"></a>7.1. Global variables</h3></div></div></div><p>Global variables are the variables declared in the main body of a VDL program. A global variable extends to any procedures and blocks defined in the program and can be referenced anywhere within the program. The syntax for declaring a global variable is not different from the others, it is just that its scope applies to the whole program.</p></div><div class="sect2" title="7.2. Local variables"><div class="titlepage"><div><div><h3 class="title"><a name="id2569147"></a>7.2. Local variables</h3></div></div></div><p>A local variable occurs in a block. A block is a section of code, which consists of one or more statements that can be grouped together. Examples of a block include an <span class="emphasis"><em>if</em></span> statement, a <span class="emphasis"><em>switch</em></span>, or a <span class="emphasis"><em>while</em></span> statement, etc. Blocks can be nested with one block inside another.</p><p>A local variable can be declared, for instance, within the body of a compound procedure, or in a <span class="emphasis"><em>while</em></span> or <span class="emphasis"><em>switch</em></span> statement. </p><p>A local variable may also be declared within a <span class="emphasis"><em>foreach</em></span> statement as an iteration variable.</p></div><div class="sect2" title="7.3. Dataset-bound variable"><div class="titlepage"><div><div><h3 class="title"><a name="id2569192"></a>7.3. Dataset-bound variable</h3></div></div></div><p>When a variable is associated with a dataset, i.e. it holds the dataset handle of that dataset; it is also called a dataset-bound variable. A dataset-bound variable usually has an associated mapping specification, for details, please look at Section <a class="link" href="#sect10_4_2" title="10.4.2. Dataset Declaration">???</a></p></div><div class="sect2" title="7.4. Scopes"><div class="titlepage"><div><div><h3 class="title"><a name="id2569214"></a>7.4. Scopes</h3></div></div></div><p>A scope defines the visibility of a variable. A global variable extends to any procedures and blocks defined in the program. For a local variable, if it is defined in a block, its scope is limited to that block. If it is defined at the beginning of a procedure, its scope extends to any blocks contained within the procedure, unless a contained block defines a variable with the same name. </p></div><div class="sect2" title="7.5. Variable references"><div class="titlepage"><div><div><h3 class="title"><a name="id2569231"></a>7.5. Variable references</h3></div></div></div><p>A variable reference is an expression that refers to a variable or its sub-elements. A simple example of a variable reference is an identifier. For an <span class="emphasis"><em>array</em></span> variable, subscript can be used to reference an array element. For instance if <span class="emphasis"><em>a</em></span> is an int array, then <span class="emphasis"><em>a[2]</em></span> is a variable reference that refers to element 3 in the array. For a <span class="emphasis"><em>struct</em></span> variable, member names can be used to refer to member variables in the struct. For instance, if <span class="emphasis"><em>addr</em></span> is a struct, with string members: <span class="emphasis"><em>street</em></span>, <span class="emphasis"><em>city</em></span>, and <span class="emphasis"><em>state</em></span>, then <span class="emphasis"><em>addr.city</em></span> refers to its <span class="emphasis"><em>city</em></span> member variable.</p></div></div><div class="sect1" title="8. Procedure Definitions"><div class="titlepage"><div><div><h2 class="title"><a name="id2569286"></a>8. Procedure Definitions</h2></div></div></div><p>Datasets are operated on by <span class="emphasis"><em>procedures</em></span>, which take one or more typed data items as input, perform computations on those data item(s), and produce zero or more data items as output.</p><p>A VDL procedure can be either an <span class="emphasis"><em>atomic procedure</em></span> or a <span class="emphasis"><em>compound procedure</em></span>. An <span class="emphasis"><em>atomic </em></span>procedure definition specifies an interface to an executable program or service. A <span class="emphasis"><em>compound </em></span><span class="emphasis"><em>procedure</em></span> composes calls to atomic procedures, other compound procedures, and/or control statements: it can be viewed as a named workflow template defining a graph of multiple nodes.</p><p>A procedure definition has the form</p><div class="informaltable"><table border="1"><colgroup><col width="105.75pt"><col width="17.4pt"><col width="172.35pt"></colgroup><tbody><tr><td>
          <span class="emphasis"><em>
          ...
          <span class="emphasis"><em>::=</em></span>
        </td><td><span class="emphasis"><em>atomic-</em></span><span class="emphasis"><em>procedure-</em></span><span class="emphasis"><em>body</em></span> | <span class="emphasis"><em>compound-procedure-body</em></span></td></tr></tbody></table></div><div class="sect2" title="8.1. Atomic procedure body"><div class="titlepage"><div><div><h3 class="title"><a name="id2569637"></a>8.1. Atomic procedure body</h3></div></div></div><p>An atomic procedure defines an interface to an external executable program or Web Service, and specifies how data items passed as input and output parameters are mapped to and from application program or service arguments and results. While the header of an atomic procedure specifies the name of the procedure, and the inputs and outputs to the procedure, the body of such an atomic procedure specifies how to set up its execution environment and how to assemble the call to the procedure. Thus, it is in the body of an atomic procedure that <span class="emphasis"><em>mapping operations</em></span> may appear to access components of any physical dataset that is dataset-bound to data items passed as procedure parameters.</p><div class="informaltable"><table border="1"><colgroup><col width="114.75pt"><col width="17.4pt"><col width="181.95pt"></colgroup><tbody><tr><td>
          <span class="emphasis"><em>
          ...
          <span class="emphasis"><em>::=</em></span>
        </td><td><span class="emphasis"><em>message-part-name</em></span> ‘=’ <span class="emphasis"><em>mapping-expression </em></span> ‘;’</td></tr></tbody></table></div><p>(TODO: WSRF service specification)<span class="emphasis"><em></em></span></p></div></div><div class="sect2" title="8.2. Compound procedure body"><div class="titlepage"><div><div><h3 class="title"><a name="id2570353"></a>8.2. Compound procedure body</h3></div></div></div><p>A compound procedure body is a block of one or more VDL statements, which are executed in an order determined by their data dependencies.  </p><p>The body is comprised of <span class="emphasis"><em>procedure-statement-sequence</em></span>, which is just a sequence of statements:</p><div class="informaltable"><table border="1"><colgroup><col width="141.75pt"><col width="17.4pt"><col width="167.55pt"></colgroup><tbody><tr><td>
          <span class="emphasis"><em>
  ...
  <span class="bold"><strong> ()</strong></span>
          ...
          <span class="emphasis"><em>::=</em></span>
        </td><td>‘(’<span class="emphasis"><em> expression</em></span>‘)’</td></tr></tbody></table></div><p>Example:</p><pre class="programlisting">int i = (a + b) * 5;</pre></div><div class="sect2" title="9.2. Operators"><div class="titlepage"><div><div><h3 class="title"><a name="id2571267"></a>9.2. Operators</h3></div></div></div><p>Operators in an expression indicate what kind of operations to apply to the operands. Currently we support an assignment operator, arithmetic operators and relational operators. </p><div class="sect3" title="9.2.1. Assignment Operators"><div class="titlepage"><div><div><h4 class="title"><a name="id2571279"></a>9.2.1. Assignment Operators</h4></div></div></div><p>The assignment operator = assigns the value of the right operand to the left operand. The left operand must be a variable reference.</p></div><div class="sect3" title="9.2.2. Arithmetic Operators"><div class="titlepage"><div><div><h4 class="title"><a name="id2571292"></a>9.2.2. Arithmetic Operators</h4></div></div></div><p>Currently we support arithmetic operators + - * / %</p></div><div class="sect3" title="9.2.3. Relational Operators"><div class="titlepage"><div><div><h4 class="title"><a name="id2571303"></a>9.2.3. Relational Operators</h4></div></div></div><p>The relational operators ==, !=, &lt;, &gt;, &lt;= and &gt;= are comparison operators, and the result of the comparisons evaluates to either <span class="bold"><strong>true</strong></span> or <span class="bold"><strong>false</strong></span>. For instance, <span class="emphasis"><em>x==y</em></span> evaluates to true is x is equal to y, and false otherwise.</p></div><div class="sect3" title="9.2.4. Boolean Expressions"><div class="titlepage"><div><div><h4 class="title"><a name="id2571335"></a>9.2.4. Boolean Expressions</h4></div></div></div><p>A boolean expression is an expression that evaluates to either true or false. There are three boolean operators: &amp;&amp;  || ! for AND, OR, and NOT operations respectively.</p><p>The controlling conditional expression of an if-statement, while-statement, or repeat-statement is a boolean expression.</p></div></div></div><div class="sect1" title="10. Statements"><div class="titlepage"><div><div><h2 class="title"><a name="id2571356"></a>10. Statements</h2></div></div></div><div class="sect2" title="10.1. Namespace Statement"><div class="titlepage"><div><div><h3 class="title"><a name="sect10_1"></a>10.1. Namespace Statement</h3></div></div></div><p>The namespace statement MUST appear at the very beginning of a VDL program, and the namespace must be unique. It serves similar purpose as a Java package definition, so that the type definitions and procedure definitions defined in this namespace would not collide with others defined outside. The syntax for namespace definition is as follows:</p><p>“<span class="bold"><strong>namespace</strong></span>”  (<span class="emphasis"><em>prefix</em></span>)?<span class="emphasis"><em></em></span><span class="emphasis"><em> ‘“’  </em></span><span class="emphasis"><em>uri</em></span><span class="emphasis"><em>  ‘”’  </em></span>(<span class="emphasis"><em>‘;’</em></span>)?</p><p><span class="emphasis"><em>prefix</em></span> is the abbreviation of the namespace denoted by <span class="emphasis"><em>uri</em></span>. If prefix is ommitted, then the namespace is regarded as the default namespace. If a default namespace is not defined in the program, it assumes the value</p><p>“http://www.griphyn.org/vds/2006/08/nonamespace”</p><p>Some examples:</p><pre class="programlisting">
  <p>namespace“http://www.griphyn.org/”</p>
  <p>namespacefmri“http://www.fmridc.org/”</p>
  </pre><p>For the definitions that follow the namespace statement, they all belong to the default namespace unless otherwise specified.</p></div><div class="sect2" title="10.2. Include Statements"><div class="titlepage"><div><div><h3 class="title"><a name="id2571554"></a>10.2. Include Statements</h3></div></div></div><p>An include statement is used to include type definitions defined in an external XML Schema document, or to include another program defined in VDL, so that the type definitions and procedure definitions can be used directly within the current VDL program.</p><p>An include statement is of the form:</p><p>“<span class="bold"><strong>include</strong></span>”<span class="bold"><strong> </strong></span>‘<span class="bold"><strong>“</strong></span>’<span class="bold"><strong> </strong></span><span class="emphasis"><em>include-file-name</em></span><span class="emphasis"><em> ‘</em></span><span class="bold"><strong><span class="emphasis"><em>”</em></span></strong></span><span class="emphasis"><em>’</em></span></p><p>Since the definitions in the included file may have a different namespace from the one in the current program, it is necessary to explicitly specify the namespace for those definitions when they are used in the current program.</p></div><div class="sect2" title="10.3. Type Definitions"><div class="titlepage"><div><div><h3 class="title"><a name="id2571618"></a>10.3. Type Definitions</h3></div></div></div><p>A type definition is usually used at the beginning of a program, to define the structure of a new type, which can later be used to declare a variable. Type definitions have the form:</p><div class="informaltable"><table border="1"><colgroup><col width="83.25pt"><col width="17.75pt"><col width="202.75pt"></colgroup><tbody><tr><td>
          <span class="emphasis"><em>
            <span class="underline">type-definition</span>
          </em></span>
        </td><td>
          <span class="emphasis"><em>::=</em></span>
        </td><td>“<span class="bold"><strong>type</strong></span>”<span class="emphasis"><em> type-name type-specifier</em></span><span class="emphasis"><em> </em></span>‘;’ </td></tr></tbody></table></div><p>Where the <span class="emphasis"><em>type-name</em></span> is a unique identifier and the <span class="emphasis"><em>type-specifier</em></span> is either an already defined type, such as primitive types, or a struct declaration.</p><div class="sect3" title="10.3.1. Type Specifiers"><div class="titlepage"><div><div><h4 class="title"><a name="id2571718"></a>10.3.1. Type Specifiers</h4></div></div></div><p>The type specifiers are</p><p>“<span class="bold"><strong>int</strong></span>”</p><p><span class="bold"><strong></strong></span>“<span class="bold"><strong>float</strong></span>”</p><p><span class="bold"><strong></strong></span>“<span class="bold"><strong>string</strong></span>”</p><p><span class="bold"><strong></strong></span>“<span class="bold"><strong>boolean</strong></span>”</p><p><span class="bold"><strong></strong></span>“<span class="bold"><strong>date</strong></span>”</p><p><span class="bold"><strong></strong></span>“<span class="bold"><strong>uri</strong></span>”</p><p>
  <span class="emphasis"><em></em></span>
  <span class="emphasis"><em>struct-declaration</em></span>
  </p></div><div class="sect3" title="10.3.2. Struct Declarations"><div class="titlepage"><div><div><h4 class="title"><a name="id2571803"></a>10.3.2. Struct Declarations</h4></div></div></div><p>A struct declaration is of the form:</p><div class="informaltable"><table border="1"><colgroup><col width="93.9pt"><col width="19.7pt"><col width="148.85pt"></colgroup><tbody><tr><td>
          <span class="emphasis"><em>
  ...
  </pre></div></div><div class="sect2" title="10.4. Declaration Statements"><div class="titlepage"><div><div><h3 class="title"><a name="id2572145"></a>10.4. Declaration Statements</h3></div></div></div><p>A declaration statement declares a variable, or a physical dataset in the form of a <span class="emphasis"><em>dataset handle</em></span>.</p><div class="sect3" title="10.4.1. Local Variable Declaration"><div class="titlepage"><div><div><h4 class="title"><a name="id2572159"></a>10.4.1. Local Variable Declaration </h4></div></div></div><p>A local variable declaration declares one or more local variables. </p><div class="informaltable"><table border="1"><colgroup><col width="131.05pt"><col width="17.4pt"><col width="264.35pt"></colgroup><tbody><tr><td>
          <span class="emphasis"><em>
  ...
  intp[] = [1 : 9 : 2];  // numbers 1 3 5 7 9
          ...
          <span class="emphasis"><em>::=</em></span>
        </td><td><span class="emphasis"><em>identifier </em></span>‘=’<span class="emphasis"><em> </em></span><span class="emphasis"><em> mapping-</em></span><span class="emphasis"><em>expression</em></span></td></tr></tbody></table></div><p>A sample dataset declaration is shown as follows:</p><pre class="programlisting">Imageimg1&lt;image_mapper; location=“/home/archive/images/image1.jpg”&gt;;</pre><pre class="programlisting">Imageimg2&lt;simple_mapper; prefix=@img1, suffix=”.2”&gt;; </pre><p>As a dataset handle is no more than a variable holding a dataset, we can also call it a <span class="emphasis"><em>dataset-bound variable</em></span>.</p></div></div><div class="sect2" title="10.5. Expression Statements"><div class="titlepage"><div><div><h3 class="title"><a name="id2572766"></a>10.5. Expression Statements</h3></div></div></div><p>Most statements are expression statements, they take the form:</p><p><span class="emphasis"><em>expression </em></span>‘;’</p><p>Usually expression statements are assignments, or procedure calls.</p></div><div class="sect2" title="10.6. Selection Statements"><div class="titlepage"><div><div><h3 class="title"><a name="id2572788"></a>10.6. Selection Statements</h3></div></div></div><p>A selection statement selects one of a number of possible statements for execution, based on the value of a boolean expression.</p><div class="informaltable"><table border="1"><colgroup><col width="107.7pt"><col width="21.1pt"><col width="169.05pt"></colgroup><tbody><tr><td>
          <span class="emphasis"><em>
        ...
        </td></tr></tbody></table></div><div class="sect3" title="10.6.1. The if statement"><div class="titlepage"><div><div><h4 class="title"><a name="id2572872"></a>10.6.1. The if statement</h4></div></div></div><p>The if statement selects a statement for execution based on the value of a boolean expression. </p><div class="informaltable"><table border="1"><colgroup><col width="78.75pt"><col width="18.65pt"><col width="259.25pt"></colgroup><tbody><tr><td>
          <span class="emphasis"><em>
        ...
        </td></tr></tbody></table></div></div><div class="sect3" title="10.6.2. The switch statement"><div class="titlepage"><div><div><h4 class="title"><a name="id2572986"></a>10.6.2. The switch statement</h4></div></div></div><p>The switch statement selects one of many statement lists for execution based on the value of  the switch expression.</p><div class="informaltable"><table border="1"><colgroup><col width="77.7pt"><col width="17.4pt"><col width="234.75pt"></colgroup><tbody><tr><td>
          <span class="emphasis"><em>
        ...
        </td></tr></tbody></table></div><p>The repeat statement is slightly different from the while statement in that control goes to the embedded statement first, and the boolean expression is evaluated, if true, then control goes to the end point of the repeat statement, otherwise, control goes back to the embedded statement.</p></div></div><div class="sect2" title="10.8. The break statement"><div class="titlepage"><div><div><h3 class="title"><a name="id2573734"></a>10.8. The break statement</h3></div></div></div><p>The statement</p><p>“<span class="bold"><strong>break</strong></span>” ‘;’</p><p>causes termination of the smallest enclosing loop, or switch statement; control passes to the statement following the terminated statement.</p></div><div class="sect2" title="10.9. The continue statement"><div class="titlepage"><div><div><h3 class="title"><a name="id2573759"></a>10.9. The continue statement</h3></div></div></div><p>The statement</p><p>“<span class="bold"><strong>continue</strong></span>” ‘;’</p><p>causes control to pass to the loop continuation portion of the smallest enclosing loop statement; that is to the end of the loop. </p></div></div><div class="sect1" title="11. Examples"><div class="titlepage"><div><div><h2 class="title"><a name="id2573784"></a>11. Examples</h2></div></div></div><p>For detailed examples, please refer to the User Guide document in the VDS public release.</p></div><div class="sect1" title="12. Extensions to consider"><div class="titlepage"><div><div><h2 class="title"><a name="id2573796"></a>12. Extensions to consider</h2></div></div></div><p>- More atomic types, such as those defined in XML Schema</p><p>- Type inference: if the type of a formal parameter to a procedure can be inferred from its definition, then the type does not need to appear in the procedure signature. </p><p>For example, if you write</p><p></p><p>(c) myfunction (a,b)</p><p>{</p><p>     tmp=combineImages(a,b)</p><p>     c=invertImage(tmp)</p><p>}</p><p>as long as you have function prototypes for combineImages and invertImage,</p><p>you can infer from the program the types for the variables a,b and c and</p><p>hence the prototype for myfunction... and so on for the entire program.</p><p>- Literal XML snippets instead of quoted XML to avoid quoting problem.</p><p>- Blocks within a procedure, with new scopes for declaring variables</p><p>- Ability to invoke an XPath to extract a value from a document</p></div></div>
			</div>
