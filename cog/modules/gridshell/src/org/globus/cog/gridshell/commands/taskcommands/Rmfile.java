...
import org.globus.cog.gridshell.tasks.RmFileTask;
import org.globus.cog.gridshell.tasks.StartTask;
/**
 * 
 */
public class Rmfile extends AbstractDirCommand {
	/* (non-Javadoc)
	 * @see org.globus.cog.gridshell.commands.taskcommands.AbstractDirCommand#createDirTask(org.globus.cog.gridshell.commands.taskcommand.tasks.StartTask, java.lang.String)
	 */
	public AbstractFileOperationTask createDirTask(StartTask connection, String dir) throws InvalidProviderException, ProviderMethodException {		
		return new RmFileTask(connection,dir);
	}
}
