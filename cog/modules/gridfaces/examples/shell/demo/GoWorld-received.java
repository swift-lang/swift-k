public class GoWorld {
    ...
    static class MyInt {
	private int i;
        public MyInt(int i) { setIntValue(i); }
    ...
    public static void goWorld(int iterations, int sleep){
        System.out.println("GoWorld Iterations: '"+iterations+"' Sleep: '"+sleep+"'");
	...
	System.out.println("GoWorld -i ITERATIONS -s SLEEP");
        ...
        System.out.println(" -i ITERATIONS - an integer specifying the number of times to print 'hello world'; default 3");
        System.out.println(" -s SLEEP      - an integer specifying the number of seconds to sleep between each iteration default 2");
    }
}
